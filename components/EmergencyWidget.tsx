        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto shrink-0">
            <a
              ...
              className="px-8 py-4 bg-white text-primary rounded-2xl font-bold text-center spring-hover active:scale-95 transition-all shadow-md flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="px-8 py-4 bg-[#25D366] text-white rounded-2xl font-bold text-center spring-hover active:scale-95 transition-all shadow-md flex items-center justify-center gap-2 border-[0.5px] border-white/20"
            >
